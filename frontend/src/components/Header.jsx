    ...
    <nav className="sticky top-0 z-50 bg-gradient-to-r from-[#1e293b] via-[#334155] to-[#1e293b] shadow-lg border-b border-gray-900/80">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <Button variant="ghost" className="hidden md:block px-4 py-2 rounded-full text-blue-200 hover:bg-blue-900/30 hover:text-white transition font-semibold" onClick={() => navigate('/login')}>
            Sign In
          </Button>
          <Button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-full hover:from-blue-600 hover:to-blue-800 shadow-md font-semibold transition" onClick={() => navigate('/register')}>
            Sign Up
          </Button>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-gradient-to-r from-[#1e293b] via-[#334155] to-[#1e293b] px-4 pb-4 border-b border-gray-900/80 animate-fade-in-down">
          <div className="flex flex-col space-y-2">
            ...
            <Button variant="ghost" className="w-full text-blue-200 hover:bg-blue-900/30 hover:text-white font-semibold" onClick={() => { setMobileOpen(false); navigate('/login'); }}>Sign In</Button>
            <Button className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold" onClick={() => { setMobileOpen(false); navigate('/register'); }}>Sign Up</Button>
          </div>
        </div>
      )}
    </nav>
